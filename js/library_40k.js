		...
		units : {
			...
			librarianterminator : {
				...
				abilities : {
					...
					'PSYKER' : 'This model can attempt to manifest two psychic powers in each friendly Psychic phase, and attempt to deny one psychic power in each enemy Psychic phase. It knows the <i>Smite</i> power and teo psychic powers from the Interromancy discipline.',
					},
				factionkeywords : 'IMPERIUM, ADEPTUS ASTARTES, DARK ANGELS, DEATHWING',
