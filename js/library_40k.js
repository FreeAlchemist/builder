...
var library = {
	...
	imperialknights : {
		...
		adaptation : {
			...
			/*QUESTOR MECHANICUS*/
			'RAVEN' : 'Relentless Advance: Models with this Household Tradition do not suffer the penalties to their hit rolls for Advancing and firing Assault weapons. Furthermore, during a turn in which a unit with this Household Tradition Advances, all of its Heavy weapons are treated as Assault weapons (e.g. a Heavy 3 weapon is treated as an Assault 3 weapon.)',
			'TARANIS' : 'Omnissiah\'s Grace: Roll a dice each time a model with this Household Tradition loses a wound, unless that wound was lost as the result of a mortal wound; on a 6 the wound being rolled for is not lost.',
			'KRAST' : 'Cold Fury: You can re-roll failed hit rolls in thr Fight phase for a model with this Household Tradition during any turn in which it charged, was charged, or performed a Heroic Intervention. In addition, you can re-roll all failed hit rolls in the Fight phase for a model with this Household Tradition against Titanic units.',
			'VULKER' : 'Firestorm Protocols: Re-roll hit rolls of 1 for a model with this Household Tradition whenever you are resolving an attack with a ranged weapon that is targeting the closest enemy unit.',
			/*QUESTOR IMPERIALIS*/
			'TERRYN' : 'Gallant Warriors: When determing the distance that a unit with this Household Tradition Advances or charges, roll an additional D6 and discard the lowest result.',
			'GRIFFITH' : 'Glory of the charge: Add 1 to the Attacks characteristic of a model with this Household Tradition during any turn in which it charged of performed a Heroic Intervention. In addition, a model with this Household Tradition can perform Heroic Intervention as if it were a <b>CHARACTER</b>.',
			'HAWKSHROUD' : 'Oathkeepers: Models with this Household Tradition double the number of wounds they have remaining for the purposes of determing what characteristics to use on their damage table.',
			'CADMUS' : 'Hunters of the Foe: Re-roll wound rolls of 1 in the Fight phase for attacks made by models with this Household Tradition against units which only contain models with a Wounds characteristic of 12 or less.',
			'MORTAN' : 'Close-quarters Killers: Add 1 to hit rolls in the Fight phase for attacks made by a model with this Household Tradition during any turn in which it charged, was charged, or performed a Heroic Intervention.',
		},
		traits : {
			'Cunning Commander' : '',
