...
var library = {
	darkangels : {
		...
		weapons : {
			...
			COMBI
			['Combi-flamer','- Boltgun','- Flamer','Combi-grav','- Boltgun','- Grav-gun','Combi-melta','- Boltgun','- Meltagun','Combi-plasma','- Boltgun','- Plasma gun (Standard)','- Plasma gun (Supercharged)','Storm bolter']

			SPECIAL
			['Flamer','Grav-gun','Meltagun','Plasma gun (Standard)','Plasma gun (Supercharged)']

			PISTOLS
			['Bolt pistol','Grav-pistol','Plasma pistol (Standard)','Plasma pistol (Supercharged)']

			MELEE
			['Chainsword','Lightning claw','Power axe','Power fist','Power maul','Power sword','Thunder hammer']

			HEAVY
			['Grav-cannon and grav-amp','Heavy bolter','Lascannon','Missile launcher - Frag missile','Missile launcher - Krak missile','Plasma cannon (Standard)','Plasma cannon (Supercharged)','Multi-melta']
			*/
			//relics
				'Heavenfall Blade' : {
					range:'Melee',
			...
			//ranged
				...
				'Plasma exterminator (Supercharged)' : {
					range:'18',
					type:'Assault D3',
					strength:'8',
					ap:'-3',
				...
				'Plasma incinerator (Supercharged)' : {
					range:'30',
					type:'Rapid Fire 1',
					strength:'8',
					ap:'-3',
		...
		units : {
			//HQ
				...
				primarislieutenants : {
					...
					weaponoption : ['Power sword','Master-crafted stalker bolt rifle','Plasma pistol (Standard)','Plasma pistol (Supercharged)'],
					abilities : {
						'Grim Resolve' : 'You can re-roll all hit rolls of 1 for this unit whenever it shoots (including when firing Overwatch) so long as it did not move in its prior Movement phase. In addition, this unit can never lose more than one model as the result of any single failed Morale test.',
						'And They Shall Know No Fear' : 'You can re-roll failed Morale tests for this unit.',
						'Company Heroes' : 'During deployment, all models in this unit must be set up at the same time. However, once the battle has begun, each operates independently and is treated as a separate unit for all rules purposes.',
			...
			//Troops
				tacticalsquad : {
					...
					weaponoption : ['Bolt pistol','Grav-pistol','Plasma pistol (Standard)','Plasma pistol (Supercharged)','Chainsword','Lightning claw','Power axe','Power fist','Power maul','Power sword','Thunder hammer','Boltgun','Combi-flamer','- Boltgun','- Flamer','Combi-grav','- Boltgun','- Grav-gun','Combi-melta','- Boltgun','- Meltagun','Combi-plasma','- Boltgun','- Plasma gun (Standard)','- Plasma gun (Supercharged)','Storm bolter','Grav-cannon and grav-amp','Heavy bolter','Lascannon','Missile launcher - Frag missile','Missile launcher - Krak missile','Plasma cannon (Standard)','Plasma cannon (Supercharged)','Multi-melta'],
					abilities : {
						'Grim Resolve' : 'You can re-roll all hit rolls of 1 for this unit whenever it shoots (including when firing Overwatch) so long as it did not move in its prior Movement phase. In addition, this unit can never lose more than one model as the result of any single failed Morale test.',
						'And They Shall Know No Fear' : 'You can re-roll failed Morale tests for this unit.',
				...
				scoutsquad : {
					...
					pointspermodel:'11',
					weaponbasic : ['Basic melee','Frag grenade','Krak grenade','Bolt pistol','Boltgun'],
					weaponoption : ['Chainsword','Lightning claw','Power axe','Power fist','Power maul','Power sword','Thunder hammer','Grav-pistol','Plasma pistol (Standard)','Plasma pistol (Supercharged)','Sniper rifle','Astartes shotgun','Heavy bolter','Missile launcher - Frag missile','Missile launcher - Krak missile','Camo cloak'],
					abilities : {
						'Grim Resolve' : 'You can re-roll all hit rolls of 1 for this unit whenever it shoots (including when firing Overwatch) so long as it did not move in its prior Movement phase. In addition, this unit can never lose more than one model as the result of any single failed Morale test.',
						'And They Shall Know No Fear' : 'You can re-roll failed Morale tests for this unit.',
			...
			//Elites
				primarisancient : {
					...
					powerpoints:'4',
					pointspermodel:'69',
					weaponbasic : ['Frag grenade','Krak grenade','Bolt pistol','Bolt rifle'],
					abilities : {
						'Grim Resolve' : 'You can re-roll all hit rolls of 1 for this unit whenever it shoots (including when firing Overwatch) so long as it did not move in its prior Movement phase. In addition, this unit can never lose more than one model as the result of any single failed Morale test.',
			...
			//Fast
				inceptorsquad : {
					...
					weaponoption : ['Plasma exterminator (Standard)','Plasma exterminator (Supercharged)'],
					abilities : {
						'Grim Resolve' : 'You can re-roll all hit rolls of 1 for this unit whenever it shoots (including when firing Overwatch) so long as it did not move in its prior Movement phase. In addition, this unit can never lose more than one model as the result of any single failed Morale test.',
						'And They Shall Know No Fear' : 'You can re-roll failed Morale tests for this unit.',
			...
			//Heavy
				hellblastersquad : {
					...
					models : [5,10],
					pointspermodel:'18',
					weaponbasic : ['Basic melee','Frag grenade','Krak grenade','Bolt pistol','Plasma incinerator (Standard)','Plasma incinerator (Supercharged)'],
					weaponoption : ['Plasma pistol (Standard)','Plasma pistol (Supercharged)','Assault plasma incinerator (Standard)','Assault plasma incinerator (Supercharged)','Heavy plasma incinerator (Standard)','Heavy plasma incinerator (Supercharged)'],
					abilities : {
						'Grim Resolve' : 'You can re-roll all hit rolls of 1 for this unit whenever it shoots (including when firing Overwatch) so long as it did not move in its prior Movement phase. In addition, this unit can never lose more than one model as the result of any single failed Morale test.',
						'And They Shall Know No Fear' : 'You can re-roll failed Morale tests for this unit.',
