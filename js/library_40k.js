	...
	tyranids : {
		...
		units : {
			...
			//Elites
				...
				weaponbasic : ['Rending claws','Grasping talons','Flesh hooks'],
				abilities : {
					'Superior Chameleonic Skin' : 'Your opponent must substract 2 from their hit rolls for attacks that target Deathleaper. In addition, add 2 instead of 1 to saving throws for Deathleaper when it is in cover.',
					'Its After Me!' : 'At the start of the first battle round but before the first turn begins, pick a <b>CHARACTER</b> from the opposing army. You can re-roll hit and wound rolls in the Fight phase for any Dethleapers attacks that target that <b>CHARACTER</b>.',
					'Hidden Hunter' : 'During deployment, you can set up Deathleaper in hiding instead of placing it on the battlefield. At the end of any of your Movement phases, set it up anywhere on the battleield that is more than 9 away from any enemy models. You can re-roll Deathleapers charge distance in the turn in which it uses this ability to arrive on the battlefield.',
					'Hive Fleet' :'',
					},
				factionkeywords : 'TYRANIDS, HIVE FLEET',
