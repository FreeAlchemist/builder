		...
		units : {
			...
			//Elites
				...
				deathwingterminators1 : {
					name:'Deathwing Terminator Squad (1)',
					role:'Elites',
					move:'5',
					ws:'3+',
					bs:'3+',
		...
		units : {
			...
			//Troops
				...
				skitariirangers1 : {
					...
					models : [5,10],
					pointspermodel:'7',
					weapon : ['Basic melee','Galvanic rifle','Transuranic arquebus','Omnispex'],
					abilities : {
						'Canticles of the Omnissiah' : 'Gain bonus in battle depending on the Canticle of the Omnissiah currently being canted.',
						'Soldiers of the machine god' : 'This unit within range of objective marker controls it if there no enemy units with such ability else who have most models.',
						'Bionics' : 'All models in this unit have a 6+ invulnerable save.',
				...
				skitariirangers2 : {
					...
					models : [5,10],
					pointspermodel:'7',
					weapon : ['Basic melee','Galvanic rifle','Power sword','Arc pistol','Plasma caliver (Standard)','Plasma caliver (Supercharge)'],
					abilities : {
						'Canticles of the Omnissiah' : 'Gain bonus in battle depending on the Canticle of the Omnissiah currently being canted.',
						'Soldiers of the machine god' : 'This unit within range of objective marker controls it if there no enemy units with such ability else who have most models.',
						'Bionics' : 'All models in this unit have a 6+ invulnerable save.',
				...
				skitariivanguard1 : {
					...
					models : [5,10],
					pointspermodel:'8',
					weapon : ['Basic melee','Radium Carbine','Taser goad','Radium pistol','Plasma caliver (Standard)','Plasma caliver (Supercharge)','Arc rifle','Enhanced Data-tether'],
					abilities : {
						'Canticles of the Omnissiah' : 'Gain bonus in battle depending on the Canticle of the Omnissiah currently being canted.',
						'Soldiers of the machine god' : 'This unit within range of objective marker controls it if there no enemy units with such ability else who have most models.',
						'Bionics' : 'All models in this unit have a 6+ invulnerable save.',
			...
			//Heavy
				...
				kastelanrobots1 : {
					...
					weaponbasic : ['Heavy phosphor blaster','Heavy phosphor blaster','Heavy phosphor blaster'],
					abilities : {
						'Canticles of the Omnissiah' : 'Gain bonus in battle depending on the Canticle of the Omnissiah currently being canted.',
						'Battle Protocols' : 'When this unit is set up, the Aegis Protocol (see below) is in effect. You can attempt to change the unit\'s battle protocol at the start of each of your Movement phases if there is a friendly <b>FORGEWORLD</b> Cybernetica Datasmith within 6". Roll a D6; on a 2+ the attempt is successful and you can select any one of the three battle protocols to take effect from the start of the next battle round. Otherwise, the attempt fails and the unit\'s current protocol remains in effect.',
						'Aegis Protocol' : 'Whilst this battle protocol is in effect, you can add 1 to any armour and invulnerable saving throws you make for this unit.',
		...
		units : {
			//HQ
				...
				inquisitormalleuspsyker1 : {
					name:'Inquisitor (Ordo Malleus) (Psyker) (1)',
					role:'HQ',
					move:'6',
					ws:'3+',
					bs:'3+',
				...
				inquisitormalleusterminatorpsyker1 : {
					name:'Inquisitor (Ordo Malleus) (Terminator) (Psyker) (1)',
					role:'HQ',
					move:'6',
					ws:'3+',
					bs:'3+',
		...
		weapons : {
			...
			//melee
				...
				'Scything talons' : {
					...
					ap:'0',
					damage:'1',
					ability:'You can re-roll hit rolls of 1 for this weapon. If the bearer has more than one pair of scything talons, it can make 1 additional attack with this weapon each tome it fights.',
					points:'0',
				},
			//ranged
				'Deathspitter' : {
				...
				'Spinefists' : {
					...
					ap:'0',
					damage:'1',
					ability:'When a model fires this weapon, it makes a number of shots equal to its Attacks char.',
					points:'',
				},	
			//other wargear
				'Adrenal glands' : {
		...
		units : {
			...
			//Fast
				raveners : {
					...
					pointspermodel:'',
					weaponbasic : ['Scything talons','Scything talons'],
					weaponoption : ['Rending claws','Deathspitter','Devourer','Spinefists'],
					// weaponoption : ['Adrenal glands','Toxin sacs (Hormagaunt)'],
					abilities : {
						'Instinctive Behaviour' : '',
